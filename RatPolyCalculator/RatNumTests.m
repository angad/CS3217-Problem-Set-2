...
-(void)setUp{
    ...
    ratNums = [[NSArray arrayWithObjects:zero, one, negOne, two,
		one_I_two, negOne_I_two, three_I_two, one_I_zero, negOne_I_zero, hundred_I_zero, nil] retain];
    ratNaNs = [[NSArray arrayWithObjects:one_I_zero, negOne_I_zero, hundred_I_zero, nil] retain];
    ratNonNaNs = [[NSArray arrayWithObjects:zero, one, negOne, two, one_I_two, three_I_two, nil] retain];	
}
...
-(void)testOneArgConstructor{
	STAssertNoThrow([[[RatNum alloc] initWithInteger:0] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithInteger:1] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithInteger:-1] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithInteger:2] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithInteger:3] release], @"", @"");
}

-(void)testTwoArgConstructor{
	STAssertNoThrow([[[RatNum alloc] initWithNumer:1 Denom:2] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:1 Denom:3] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:1 Denom:4] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:2 Denom:3] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:3 Denom:4] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:-1 Denom:2] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:3 Denom:2] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:1 Denom:0] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:-1 Denom:0] release], @"", @"");
	STAssertNoThrow([[[RatNum alloc] initWithNumer:100 Denom:0] release], @"", @"");
}
...
-(void)testIntValue{
	...
	RatNum *rnmax = [[[RatNum alloc] initWithInteger:IntMax] autorelease];
	RatNum *rnmin = [[[RatNum alloc] initWithInteger:IntMin] autorelease];
	RatNum *rnmaxd2 = [[[RatNum alloc] initWithNumer:IntMax Denom:2] autorelease];
	RatNum *rnmind2 = [[[RatNum alloc] initWithNumer:IntMin Denom:2] autorelease];
	RatNum *rnmaxmax = [[[RatNum alloc] initWithNumer:IntMax Denom:IntMax] autorelease];
	RatNum *rnminmin = [[[RatNum alloc] initWithNumer:IntMin Denom:IntMin] autorelease];
	RatNum *rn1max = [[[RatNum alloc] initWithNumer:1 Denom:IntMax] autorelease];
	RatNum *rnmax1max = [[[RatNum alloc] initWithNumer:IntMax-1 Denom:IntMax] autorelease];
...
-(void)testEquals{
	...
	RatNum *rn = [[[RatNum alloc] initWithNumer:1 Denom:1] autorelease];
	STAssertTrue([rn isEqual:rn], @"", @"");
	rn = [[[RatNum alloc] initWithNumer:1 Denom:2] autorelease];
	STAssertTrue([rn isEqual:rn], @"", @"");
	rn = [[[RatNum alloc] initWithNumer:2 Denom:2] autorelease];
	STAssertTrue([rn isEqual:rn], @"", @"");
	STAssertTrue([rn isEqual:one], @"", @"");
	rn = [[[RatNum alloc] initWithNumer:-9 Denom:9] autorelease];
	STAssertTrue([rn isEqual:negOne], @"", @"");
	STAssertTrue([negOne isEqual:rn], @"", @"");
	rn = [[[RatNum alloc] initWithNumer:-13 Denom:-26] autorelease];
...
-(void)testToStringSimple{
	RatNum *four = [[[RatNum alloc] initWithInteger:4] autorelease];
	RatNum *negFive = [[[RatNum alloc] initWithInteger:-5] autorelease];
	RatNum *negZero = [[[RatNum alloc] initWithInteger:-0] autorelease];
...
-(void)testToStringFractions{
	RatNum *negOne_I_thirteen = [[[RatNum alloc] initWithNumer:-1 Denom: 13] autorelease];
	RatNum *fiftyThree_I_seven = [[[RatNum alloc] initWithNumer:53 Denom: 7] autorelease];
...
-(void)testToStringNaN{
	RatNum *two_I_zero = [[[RatNum alloc] initWithNumer:2 Denom: 0] autorelease];
	RatNum *zero_I_zero = [[[RatNum alloc] initWithNumer:0 Denom: 0] autorelease];
	RatNum *negHundred_I_zero = [[[RatNum alloc] initWithNumer:-100 Denom: 0] autorelease];
	RatNum *two_I_one = [[[RatNum alloc] initWithNumer:2 Denom: 1] autorelease];
	RatNum *zero_I_one = [[[RatNum alloc] initWithNumer:0 Denom: 1] autorelease];
	RatNum *negOne_I_negTwo = [[[RatNum alloc] initWithNumer:-1 Denom: -2] autorelease];
	RatNum *two_I_four = [[[RatNum alloc] initWithNumer:2 Denom: 4] autorelease];
	RatNum *six_I_four = [[[RatNum alloc] initWithNumer:6 Denom: 4] autorelease];
	RatNum *twentySeven_I_thirteen = [[[RatNum alloc] initWithNumer:27 Denom: 13] autorelease];
	RatNum *negHundred_I_negHundred = [[[RatNum alloc] initWithNumer:-100 Denom: -100] autorelease];
...
-(void)tearDown{
    ...
    [one_I_four release];
    [two_I_three release];
    [three_I_four release];
	[negOne_I_two release];
    [three_I_two release];
    [one_I_zero release];
	[negOne_I_zero release];
    [hundred_I_zero release];
	[ratNums release];
	[ratNaNs release];
	[ratNonNaNs release];
}
